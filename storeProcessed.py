...
pd = pandas.read_csv("/data/06333/aroraish/modifiableE.csv", encoding='utf-8', error_bad_lines=False)

pd["message"] = pd["message"].apply(preprocess)

pd.to_csv(path_or_buf="/data/06333/aroraish/modifiableE_processed2.csv")
