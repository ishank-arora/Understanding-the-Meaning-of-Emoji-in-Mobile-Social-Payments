...
pickle.dump(dictionary, open("/data/06333/aroraish/dictionaryNM.pkl", "w"))


lda_model = gensim.models.LdaModel(bow_corpus, num_topics=25, id2word=dictionary, passes=2)

temp_file = datapath("/data/06333/aroraish/lda_model_bog_NM")
lda_model.save(temp_file)

with open("/data/06333/aroraish/lda_bog_NM.txt", 'w') as bw:
