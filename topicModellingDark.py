...
temp_file = datapath("/data/06333/aroraish/models/ldaM_dark_5.pkl")
lda_model.save(temp_file)

lda_model_tfidf = gensim.models.LdaMulticore(corpus_tfidf, num_topics=25, id2word=dictionary, passes=2)

temp_file = datapath("/data/06333/aroraish/models/ldaMtfidf_dark_5.pkl")
lda_model_tfidf.save(temp_file)

with open("/data/06333/aroraish/outputs/lda_bag_of_words_dark_5.txt", 'w') as bw:

    for idx, topic in lda_model.print_topics(-1):
        bw.write('Topic: {} \nWords: {}\n\n'.format(idx, topic.encode('utf-8')))


with open("/data/06333/aroraish/outputs/lda_tfidf_dark_5.txt", 'w') as tf:
