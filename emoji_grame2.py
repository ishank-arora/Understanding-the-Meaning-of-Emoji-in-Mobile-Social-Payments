...
c1 = pickle.load(open("/data/06333/aroraish/counter_all_1.pkl", "r"))
c2 = pickle.load(open("/data/06333/aroraish/counter_all_2.pkl", "r"))
c3 = pickle.load(open("/data/06333/aroraish/counter_all_3.pkl", "r"))
c4 = pickle.load(open("/data/06333/aroraish/counter_all_4.pkl", "r"))
...
pd3['message'].apply(n_all)

pickle.dump(c1, open("/data/06333/aroraish/counter_all_1_f.pkl", "w"))
pickle.dump(c2, open("/data/06333/aroraish/counter_all_2_f.pkl", "w"))
pickle.dump(c3, open("/data/06333/aroraish/counter_all_3_f.pkl", "w"))
pickle.dump(c4, open("/data/06333/aroraish/counter_all_4_f.pkl", "w"))
