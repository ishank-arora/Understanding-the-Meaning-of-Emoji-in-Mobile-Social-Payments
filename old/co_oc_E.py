...
modN = csv.DictReader(open("/data/06333/aroraish/modifiableE_processed.csv", "r"))

for row in modN:
    n_all(row['message'].decode('utf-8'))

pickle.dump(co_oc, open("/data/06333/aroraish/cooc_E.pkl", "w"))
