...
pd = pandas.read_csv("/data/06333/aroraish/modifiableN_processed.csv", encoding='utf-8', low_memory=False, usecols=['message'], error_bad_lines=False, chunksize=1000000)
chunklist = []
...
pickle.dump(dictionary, open("/data/06333/aroraish/dictionary2NM.pkl", "w"))
...
temp_file = datapath("/data/06333/aroraish/lda_model_tfidf_NM")
...
with open("/data/06333/aroraish/lda_tf_idf_NM.txt", 'w') as bw:
