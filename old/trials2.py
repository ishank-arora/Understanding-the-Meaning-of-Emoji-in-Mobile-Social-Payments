...
pickle.dump(c1, open("/data/06333/aroraish/textnm1.pkl", "w"))
pickle.dump(c2, open("/data/06333/aroraish/textnm2.pkl", "w"))
pickle.dump(c3, open("/data/06333/aroraish/textnm3.pkl", "w"))
