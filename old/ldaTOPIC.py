...
pickle.dump(bow_corpus, open("/data/06333/aroraish/bow_corpus_all.pkl", "w"))


lda_model = gensim.models.LdaModel(bow_corpus, num_topics=25, id2word=dictionary, passes=2)

temp_file = datapath("/data/06333/aroraish/lda_model_bog_2")
lda_model.save(temp_file)

with open("/data/06333/aroraish/lda_bog_2.txt", 'w') as bw:
...
lda_model = gensim.models.LdaModel(corpus_tfidf, num_topics=25, id2word=dictionary, passes=2)

temp_file = datapath("/data/06333/aroraish/lda_model_tfidf")
lda_model.save(temp_file)
...
with open("/data/06333/aroraish/lda_tf_idf.txt", 'w') as bw:
