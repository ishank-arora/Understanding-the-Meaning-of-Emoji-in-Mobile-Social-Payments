...
pd = pandas.read_csv("/data/06333/aroraish/flat/flat_medium_light_proc_2.csv", encoding='utf-8', error_bad_lines=False)
...
pickle.dump(lda_model, open("/data/06333/aroraish/models/ldaM_light_medium_3.pkl", "w"))

lda_model_tfidf = gensim.models.LdaMulticore(corpus_tfidf, num_topics=50, id2word=dictionary, passes=2, workers=1)

pickle.dump(lda_model, open("/data/06333/aroraish/models/ldaMtfidf_light_medium_2.pkl", "w"))

with open("/data/06333/aroraish/outputs/lda_bag_of_words_light_medium_3.txt", 'w') as bw:

    for idx, topic in lda_model.print_topics(-1):
        bw.write('Topic: {} \nWords: {}\n\n'.format(idx, topic.encode('utf-8')))


with open("/data/06333/aroraish/outputs/lda_tfidf_light_medium_3.txt", 'w') as tf:
